...
# 2 random recurse
python train.py -m name=minatar_rnn_randrec2_2trans \
agent=a2c_image agent.network_params.architecture=rnn \
env=minatar \
seed=0,0,0 \
...
python train.py -m name=minatar_crnn_randrec2_2trans \
agent=a2c_image agent.network_params.architecture=crnn \
env=minatar \
seed=0,0,0 \
agent.network_params.random_cog_fraction=0.5 \
